...
<table width="100%" >
	<tr>
		...
		<td width="25%" align="center" style = "font-size: 50px;">
...
<div>
	<table align="center" >
		<c:forEach var = "postArrayItem" varStatus="sv" items = "${postArray}" >
		<c:if test="${sv.first}">
			<tr>
			</c:if>
				<td align="center" style = "font-size: 30px;" class = "gazou">
					<c:out value = "${postArrayItem.p_user}"/><br>
					<img src="${postArrayItem.p_img }"  class = "toukou">
				</td>
				<c:if test="${sv.count%3==0}">
			</tr>
			<tr>
				</c:if >
				<c:if test="${sv.last}">
